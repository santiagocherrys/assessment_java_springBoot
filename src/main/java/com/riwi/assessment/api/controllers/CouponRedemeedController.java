...
public class CouponRedemeedController {
    ...
    @GetMapping
        public ResponseEntity<Page<CouponRedemeedResponse>> getAll( @RequestParam(defaultValue = "1") int page, @RequestParam( defaultValue = "10") int size){
            return ResponseEntity.ok(this.couponRedemeedService.getAll(page-1, size));
